...
public class WriteProgramTextCaption implements BxFileWriterListener<Bx5GScreen> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // code 1: using object
        area.addPage(new TextBxPage("本文1"));
        area.addPage(new TextFileBxPage("c:\\temp\\news.txt"));
        area.addPage(new ImageFileBxPage("c:\\temp\\news.png"));

        // code 2: using method
        area.addText("測試文字", new Font("Tahoma", Font.PLAIN, 16), ColorType2.RED, ColorType2.BLACK, DisplayStyleFactory.getStyle(6));
        area.addTextFile("c:\\temp\\news.txt", new Font("Tahoma", Font.PLAIN, 16), ColorType2.RED, ColorType2.BLACK, DisplayStyleFactory.getStyle(6));
        area.addImageFile("c:\\temp\\news.png", DisplayStyleFactory.getStyle(6));
